...
//mm dd yyyy format
var fectchedDateandTIme= document.getElementById("dateFromTheGroup").innerHTML+" "+document.getElementById("startTime").innerHTML+":00";
console.log(fectchedDateandTIme);
